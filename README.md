...
Description: This class represents the entry point of the Hotel Booking Management System. At this stage, the application:
...
No business logic, data structures, or user input is implemented in this use case. The goal is to establish a clear and predictable application startup point.
